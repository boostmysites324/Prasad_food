          ...
          {navItems.map((item) => (
            item.isExternal ? (
              <a
                ...
                className="font-medium text-base cursor-pointer transition-colors hover:text-[#FF9933] text-gray-700 !rounded-button whitespace-nowrap"
              >
                {item.name}
              </a>
            ) : (
            ...
            {navItems.map((item) => (
              item.isExternal ? (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block py-2 px-4 w-full text-left cursor-pointer transition-colors hover:text-[#FF9933] text-gray-700 !rounded-button whitespace-nowrap"
